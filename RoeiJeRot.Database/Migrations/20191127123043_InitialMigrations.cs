...
namespace RoeiJeRot.Database.Migrations
{
    public partial class InitialMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_sailing_competition_participants_sailing_boats_SailingBoatId",
                        column: x => x.SailingBoatId,
                        principalTable: "sailing_boats",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sailing_competition_participants_SailingBoatId",
                table: "sailing_competition_participants",
                column: "SailingBoatId");
