...
namespace RoeiJeRot.Test
{
    ...
    {
        [TestCase("2020-11-18 13:00", 120, true)]
        [TestCase("2020-11-18 20:00", 120, false)]
        [TestCase("2020-11-18 23:00", 120, false)]
        [TestCase("2020-11-18 8:05", 120, true)]
        [TestCase("2020-11-18 8:00", 120, false)]
        [TestCase("2020-11-18 16:34", 120, false)]
        [Test]
